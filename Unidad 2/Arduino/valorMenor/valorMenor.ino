...
int valorMenor = 1024; // por que es el valor mas grande para que entre a la interacion y debe ser mayor al numero que se puede leer
int valor[30];
void loop() {
...
// siempre debe de tener una razon 